...
def detect(obj_source, obj_project, obj_name, save_img=False):
...
def bridge(obj_source, obj_project, obj_name):
    check_requirements(exclude=('pycocotools', 'thop'))
    with torch.no_grad():
        detect(obj_source, obj_project, obj_name)
