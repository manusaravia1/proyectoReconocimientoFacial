        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):  # Paralelizacion
                    ...
                    cv2.putText(im0, person_name, (int(xywh[0][0]) + 2, int(xywh[0][1]) + 20), font, 0.5, color, 1)
                    cv2.putText(im0, str(direction), (int(xywh[0][2]) - 80, int(xywh[0][1]) + 20), font, 0.5, color, 1)
